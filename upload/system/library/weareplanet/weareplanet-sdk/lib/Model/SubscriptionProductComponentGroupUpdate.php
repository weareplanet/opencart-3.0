...
class SubscriptionProductComponentGroupUpdate implements ModelInterface, ArrayAccess
{
     ...
     * Sets name
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedStringCreate $name The component group name will be shown when the components are selected. This can be visible to the subscriber.
     *
     * @return $this
     */
