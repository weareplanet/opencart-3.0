...
class PaymentConnectorConfiguration implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'conditions' => 'int[]',
        'connector' => 'int',
        'enabled_sales_channels' => '\WeArePlanet\Sdk\Model\SalesChannel[]',
        'enabled_space_views' => 'int[]',
        'id' => 'int',
        'linked_space_id' => 'int',
        'name' => 'string',
        'payment_method_configuration' => '\WeArePlanet\Sdk\Model\PaymentMethodConfiguration',
     ...
     *
     * @return \WeArePlanet\Sdk\Model\SalesChannel[]
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\SalesChannel[] $enabled_sales_channels Defines the sales channels the connector configuration is enabled for. In case the set is empty, the connector configuration is enabled for all sales channels.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentMethodConfiguration $payment_method_configuration 
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentProcessorConfiguration $processor_configuration 
     *
     * @return $this
     */
