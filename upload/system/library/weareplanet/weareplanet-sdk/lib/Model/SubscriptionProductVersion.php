...
class SubscriptionProductVersion implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'product' => '\WeArePlanet\Sdk\Model\SubscriptionProduct',
        'reference' => 'string',
        'retiring_finished_on' => '\DateTime',
        'retiring_started_on' => '\DateTime',
        'state' => '\WeArePlanet\Sdk\Model\SubscriptionProductVersionState',
        'tax_calculation' => '\WeArePlanet\Sdk\Model\TaxCalculation',
        'version' => 'int'
    ];
     ...
     * Sets name
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedString $name The product version name is the name of the product which is shown to the user for the version. When the visible product name should be changed for a particular product a new version has to be created which contains the new name of the product.
     *
     * @return $this
     */
     ...
     * Gets product
     *
     * @return \WeArePlanet\Sdk\Model\SubscriptionProduct
     */
     ...
     * Sets product
     *
     * @param \WeArePlanet\Sdk\Model\SubscriptionProduct $product Each product version is linked to a product.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\SubscriptionProductVersionState
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\SubscriptionProductVersionState $state 
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\TaxCalculation
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TaxCalculation $tax_calculation Strategy that is used for tax calculation in fees.
     *
     * @return $this
     */
