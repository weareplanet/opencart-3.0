...
class PaymentLink implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'protection_mode' => '\WeArePlanet\Sdk\Model\PaymentLinkProtectionMode',
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentMethodConfiguration[] $allowed_payment_method_configurations The allowed payment method configurations restrict the payment methods which can be used with this payment link.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $line_items The line items allows to define the line items for this payment link. When the line items are defined they cannot be overridden through the request parameters.
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\PaymentLinkProtectionMode
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentLinkProtectionMode $protection_mode The protection mode determines if the payment link is protected against tampering and in what way.
     *
     * @return $this
     */
