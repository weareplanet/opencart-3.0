...
class AbstractPaymentLinkUpdate implements ModelInterface, ArrayAccess
{
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItemCreate[] $line_items The line items allows to define the line items for this payment link. When the line items are defined they cannot be overridden through the request parameters.
     *
     * @return $this
     */
