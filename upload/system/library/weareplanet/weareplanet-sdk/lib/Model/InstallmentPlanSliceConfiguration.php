...
class InstallmentPlanSliceConfiguration implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'line_item_title' => '\WeArePlanet\Sdk\Model\DatabaseTranslatedString',
        'linked_space_id' => 'int',
        'period' => 'string',
        'plan' => '\WeArePlanet\Sdk\Model\InstallmentPlanConfiguration',
     ...
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedString $line_item_title The title of this slices line items. The title is visible to the buyer.
     *
     * @return $this
     */
     ...
     * Sets plan
     *
     * @param \WeArePlanet\Sdk\Model\InstallmentPlanConfiguration $plan The installment plan this slice belongs to.
     *
     * @return $this
     */
