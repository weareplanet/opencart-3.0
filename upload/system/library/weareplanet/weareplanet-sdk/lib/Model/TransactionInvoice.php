...
class TransactionInvoice extends TransactionAwareEntity 
{
    ...
    protected static $swaggerTypes = [
        ...
        'completion' => '\WeArePlanet\Sdk\Model\TransactionCompletion',
        'created_on' => '\DateTime',
        'derecognized_by' => 'int',
        ...
        'space_view_id' => 'int',
        'state' => '\WeArePlanet\Sdk\Model\TransactionInvoiceState',
        'tax_amount' => 'float',
        'time_zone' => 'string',
        'version' => 'int'
    ];
     ...
     * Sets completion
     *
     * @param \WeArePlanet\Sdk\Model\TransactionCompletion $completion 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\TransactionInvoiceState
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\TransactionInvoiceState $state The object's current state.
     *
     * @return $this
     */
