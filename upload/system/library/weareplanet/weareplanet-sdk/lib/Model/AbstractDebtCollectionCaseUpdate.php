...
class AbstractDebtCollectionCaseUpdate implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\AddressCreate $billing_address The billing address of the case identifies the debtor.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItemCreate[] $line_items The line items of the debt collection case will be shown on documents sent to the debtor and the total of them makes up total amount to collect.
     *
     * @return $this
     */
