...
class ProductPeriodFeeUpdate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'ledger_entry_title' => '\WeArePlanet\Sdk\Model\DatabaseTranslatedStringCreate',
        'name' => '\WeArePlanet\Sdk\Model\DatabaseTranslatedStringCreate',
        'number_of_free_trial_periods' => 'int',
        'period_fee' => '\WeArePlanet\Sdk\Model\PersistableCurrencyAmountUpdate[]'
    ];
     ...
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedStringCreate $ledger_entry_title The ledger entry title will be used for the title in the ledger entry and in the invoice.
     *
     * @return $this
     */
     ...
     * Sets period_fee
     *
     * @param \WeArePlanet\Sdk\Model\PersistableCurrencyAmountUpdate[] $period_fee The period fee is charged for every period of the subscription except for those periods which are trial periods.
     *
     * @return $this
     */
