...
class Refund implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'amount' => 'float',
        'base_line_items' => '\WeArePlanet\Sdk\Model\LineItem[]',
        'completion' => 'int',
        'created_by' => 'int',
        'created_on' => '\DateTime',
        ...
        'reduced_line_items' => '\WeArePlanet\Sdk\Model\LineItem[]',
        'reductions' => '\WeArePlanet\Sdk\Model\LineItemReduction[]',
        'state' => '\WeArePlanet\Sdk\Model\RefundState',
        'succeeded_on' => '\DateTime',
        'taxes' => '\WeArePlanet\Sdk\Model\Tax[]',
        'time_zone' => 'string',
        'timeout_on' => '\DateTime',
        'total_applied_fees' => 'float',
        'total_settled_amount' => 'float',
        'transaction' => '\WeArePlanet\Sdk\Model\Transaction',
        'type' => '\WeArePlanet\Sdk\Model\RefundType',
        'updated_invoice' => 'int',
        'version' => 'int'
    ];
     ...
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $base_line_items 
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $reduced_line_items 
     *
     * @return $this
     */
     ...
     * Gets reductions
     *
     * @return \WeArePlanet\Sdk\Model\LineItemReduction[]
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\RefundState
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\RefundState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Gets taxes
     *
     * @return \WeArePlanet\Sdk\Model\Tax[]
     */
     ...
     * Sets taxes
     *
     * @param \WeArePlanet\Sdk\Model\Tax[] $taxes 
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \WeArePlanet\Sdk\Model\RefundType
     */
     ...
     * Sets type
     *
     * @param \WeArePlanet\Sdk\Model\RefundType $type 
     *
     * @return $this
     */
