...
class SubscriptionProductComponentUpdate implements ModelInterface, ArrayAccess
{
     ...
     * Sets description
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedStringCreate $description The component description may contain a longer description which gives the subscriber a better understanding of what the component contains.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedStringCreate $name The component name is shown to the subscriber. It should describe in few words what the component does contain.
     *
     * @return $this
     */
