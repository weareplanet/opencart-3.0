...
class Transaction implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'completion_behavior' => '\WeArePlanet\Sdk\Model\TransactionCompletionBehavior',
        ...
        'customer_id' => 'string',
        'customers_presence' => '\WeArePlanet\Sdk\Model\CustomersPresence',
        'delivery_decision_made_on' => '\DateTime',
        'device_session_identifier' => 'string',
        'emails_disabled' => 'bool',
        'end_of_life' => '\DateTime',
        'environment' => '\WeArePlanet\Sdk\Model\Environment',
        'environment_selection_strategy' => '\WeArePlanet\Sdk\Model\TransactionEnvironmentSelectionStrategy',
        'failed_on' => '\DateTime',
        'failed_url' => 'string',
        'failure_reason' => '\WeArePlanet\Sdk\Model\FailureReason',
        'group' => '\WeArePlanet\Sdk\Model\TransactionGroup',
        'id' => 'int',
        ...
        'parent' => 'int',
        'payment_connector_configuration' => '\WeArePlanet\Sdk\Model\PaymentConnectorConfiguration',
        ...
        'space_view_id' => 'int',
        'state' => '\WeArePlanet\Sdk\Model\TransactionState',
        'success_url' => 'string',
        'terminal' => '\WeArePlanet\Sdk\Model\PaymentTerminal',
        'time_zone' => 'string',
        'token' => '\WeArePlanet\Sdk\Model\Token',
        'tokenization_mode' => '\WeArePlanet\Sdk\Model\TokenizationMode',
     ...
     *
     * @return \WeArePlanet\Sdk\Model\ChargeAttemptEnvironment
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\ChargeAttemptEnvironment $authorization_environment The environment in which this transaction was successfully authorized.
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\Address
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\Address $billing_address 
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\TransactionCompletionBehavior
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TransactionCompletionBehavior $completion_behavior The completion behavior controls when the transaction is completed.
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\CustomersPresence
     */
     ...
     * Gets environment
     *
     * @return \WeArePlanet\Sdk\Model\Environment
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\TransactionEnvironmentSelectionStrategy
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TransactionEnvironmentSelectionStrategy $environment_selection_strategy The environment selection strategy determines how the environment (test or production) for processing the transaction is selected.
     *
     * @return $this
     */
     ...
     * Sets failure_reason
     *
     * @param \WeArePlanet\Sdk\Model\FailureReason $failure_reason The failure reason describes why the transaction failed. This is only provided when the transaction is marked as failed.
     *
     * @return $this
     */
     ...
     * Gets group
     *
     * @return \WeArePlanet\Sdk\Model\TransactionGroup
     */
     ...
     * Sets group
     *
     * @param \WeArePlanet\Sdk\Model\TransactionGroup $group 
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $line_items 
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\PaymentConnectorConfiguration
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentConnectorConfiguration $payment_connector_configuration 
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\Address $shipping_address 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\TransactionState
     */
     ...
     * Gets terminal
     *
     * @return \WeArePlanet\Sdk\Model\PaymentTerminal
     */
     ...
     * Sets terminal
     *
     * @param \WeArePlanet\Sdk\Model\PaymentTerminal $terminal The terminal on which the payment was processed.
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param \WeArePlanet\Sdk\Model\Token $token 
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\TokenizationMode
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TokenizationMode $tokenization_mode The tokenization mode controls if and how the tokenization of payment information is applied to the transaction.
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\TransactionUserInterfaceType
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TransactionUserInterfaceType $user_interface_type The user interface type defines through which user interface the transaction has been processed resp. created.
     *
     * @return $this
     */
