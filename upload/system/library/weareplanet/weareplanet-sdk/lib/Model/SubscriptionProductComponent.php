...
class SubscriptionProductComponent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'component_group' => '\WeArePlanet\Sdk\Model\SubscriptionProductComponentGroup',
        ...
        'quantity_step' => 'float',
        'reference' => '\WeArePlanet\Sdk\Model\SubscriptionProductComponentReference',
        'sort_order' => 'int',
        'tax_class' => '\WeArePlanet\Sdk\Model\TaxClass',
        'version' => 'int'
    ];
     ...
     *
     * @return \WeArePlanet\Sdk\Model\SubscriptionProductComponentGroup
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\SubscriptionProductComponentGroup $component_group 
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedString $description The component description may contain a longer description which gives the subscriber a better understanding of what the component contains.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedString $name The component name is shown to the subscriber. It should describe in few words what the component does contain.
     *
     * @return $this
     */
     ...
     * Gets reference
     *
     * @return \WeArePlanet\Sdk\Model\SubscriptionProductComponentReference
     */
     ...
     * Sets reference
     *
     * @param \WeArePlanet\Sdk\Model\SubscriptionProductComponentReference $reference The component reference is used to identify the component by external systems and it marks components to represent the same component within different product versions.
     *
     * @return $this
     */
     ...
     * Gets tax_class
     *
     * @return \WeArePlanet\Sdk\Model\TaxClass
     */
     ...
     * Sets tax_class
     *
     * @param \WeArePlanet\Sdk\Model\TaxClass $tax_class The tax class of the component determines the taxes which are applicable on all fees linked with the component.
     *
     * @return $this
     */
