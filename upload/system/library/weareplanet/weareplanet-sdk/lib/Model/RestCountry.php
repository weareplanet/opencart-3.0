...
class RestCountry implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'address_format' => '\WeArePlanet\Sdk\Model\RestAddressFormat',
        'name' => 'string',
        'numeric_code' => 'string',
        'state_codes' => 'string[]'
    ];
     ...
     * Gets address_format
     *
     * @return \WeArePlanet\Sdk\Model\RestAddressFormat
     */
     ...
     * Sets address_format
     *
     * @param \WeArePlanet\Sdk\Model\RestAddressFormat $address_format The address format of the country indicates how an address has to look like for the country.
     *
     * @return $this
     */
