...
class PaymentAppProcessor implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'configured_environment' => '\WeArePlanet\Sdk\Model\ChargeAttemptEnvironment',
        'created_on' => '\DateTime',
        ...
        'linked_space_id' => 'int',
        'name' => 'string',
        'processor_configuration' => '\WeArePlanet\Sdk\Model\PaymentProcessorConfiguration',
        'production_mode_url' => 'string',
        'state' => '\WeArePlanet\Sdk\Model\PaymentAppProcessorState',
        'svg_icon' => 'string',
        'updated_on' => '\DateTime',
     ...
     *
     * @param \WeArePlanet\Sdk\Model\ChargeAttemptEnvironment $configured_environment 
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\PaymentProcessorConfiguration
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentProcessorConfiguration $processor_configuration This processor configuration is created as part of the app processor. Any transaction created with the processor is linked with this processor configuration.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\PaymentAppProcessorState
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\PaymentAppProcessorState $state The object's current state.
     *
     * @return $this
     */
