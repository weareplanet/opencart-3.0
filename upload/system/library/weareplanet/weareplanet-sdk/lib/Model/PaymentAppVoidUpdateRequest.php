...
class PaymentAppVoidUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'reference' => 'string',
        'target_state' => '\WeArePlanet\Sdk\Model\PaymentAppVoidTargetState',
        'void_id' => 'int'
    ];
     ...
     * Gets target_state
     *
     * @return \WeArePlanet\Sdk\Model\PaymentAppVoidTargetState
     */
     ...
     * Sets target_state
     *
     * @param \WeArePlanet\Sdk\Model\PaymentAppVoidTargetState $target_state The target state defines the state into which the void should be switched into. Once the void changed the state it will not be possible to change it again.
     *
     * @return $this
     */
