...
class ProductMeteredTierFeeUpdate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'version' => 'int',
        'fee' => '\WeArePlanet\Sdk\Model\PersistableCurrencyAmountUpdate[]',
        'metered_fee' => 'int',
        'start_range' => 'float'
    ];
     ...
     * Sets fee
     *
     * @param \WeArePlanet\Sdk\Model\PersistableCurrencyAmountUpdate[] $fee The fee determines the amount which is charged. The consumed metric is multiplied by the defined fee. The resulting amount is charged at the end of the period.
     *
     * @return $this
     */
