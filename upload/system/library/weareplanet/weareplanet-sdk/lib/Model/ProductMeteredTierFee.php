...
class ProductMeteredTierFee implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'fee' => '\WeArePlanet\Sdk\Model\PersistableCurrencyAmount[]',
        'id' => 'int',
        'metered_fee' => '\WeArePlanet\Sdk\Model\ProductMeteredFee',
        'start_range' => 'float',
        'version' => 'int'
    ];
     ...
     * Sets fee
     *
     * @param \WeArePlanet\Sdk\Model\PersistableCurrencyAmount[] $fee The fee determines the amount which is charged. The consumed metric is multiplied by the defined fee. The resulting amount is charged at the end of the period.
     *
     * @return $this
     */
     ...
     * Sets metered_fee
     *
     * @param \WeArePlanet\Sdk\Model\ProductMeteredFee $metered_fee 
     *
     * @return $this
     */
