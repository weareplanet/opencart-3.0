...
class ShopifySubscriptionProduct implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'pricing_option' => '\WeArePlanet\Sdk\Model\ShopifySubscriptionProductPricingOption',
        'product_id' => 'string',
        'product_name' => 'string',
        'product_price' => 'float',
        'product_sku' => 'string',
        ...
        'shop' => 'int',
        'state' => '\WeArePlanet\Sdk\Model\ShopifySubscriptionProductState',
     ...
     *
     * @param \WeArePlanet\Sdk\Model\ShopifySubscriptionBillingIntervalUnit $billing_interval_unit Define how frequently recurring orders should be created.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\ShopifySubscriptionWeekday $billing_weekday Define the weekday on which the recurring orders should be created.
     *
     * @return $this
     */
     ...
     * Gets pricing_option
     *
     * @return \WeArePlanet\Sdk\Model\ShopifySubscriptionProductPricingOption
     */
     ...
     * Sets pricing_option
     *
     * @param \WeArePlanet\Sdk\Model\ShopifySubscriptionProductPricingOption $pricing_option 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\ShopifySubscriptionProductState
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\ShopifySubscriptionProductState $state 
     *
     * @return $this
     */
