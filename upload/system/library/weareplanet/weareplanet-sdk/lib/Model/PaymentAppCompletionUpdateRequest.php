...
class PaymentAppCompletionUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'reference' => 'string',
        'target_state' => '\WeArePlanet\Sdk\Model\PaymentAppCompletionTargetState'
    ];
     ...
     * Gets target_state
     *
     * @return \WeArePlanet\Sdk\Model\PaymentAppCompletionTargetState
     */
     ...
     * Sets target_state
     *
     * @param \WeArePlanet\Sdk\Model\PaymentAppCompletionTargetState $target_state The target state defines the state into which the completion should be switched into. Once the completion changed the state it will not be possible to change it again.
     *
     * @return $this
     */
