...
class ProductSetupFee implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'component' => '\WeArePlanet\Sdk\Model\SubscriptionProductComponent',
        'description' => '\WeArePlanet\Sdk\Model\DatabaseTranslatedString',
        'id' => 'int',
        'linked_space_id' => 'int',
        'name' => '\WeArePlanet\Sdk\Model\DatabaseTranslatedString',
        'on_downgrade_credited_amount' => '\WeArePlanet\Sdk\Model\PersistableCurrencyAmount[]',
        'on_upgrade_credited_amount' => '\WeArePlanet\Sdk\Model\PersistableCurrencyAmount[]',
        'setup_fee' => '\WeArePlanet\Sdk\Model\PersistableCurrencyAmount[]',
        'type' => '\WeArePlanet\Sdk\Model\ProductFeeType',
        'version' => 'int'
    ];
     ...
     * Gets component
     *
     * @return \WeArePlanet\Sdk\Model\SubscriptionProductComponent
     */
     ...
     * Sets component
     *
     * @param \WeArePlanet\Sdk\Model\SubscriptionProductComponent $component 
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedString $description The description of a component fee describes the fee to the subscriber. The description may be shown in documents or on certain user interfaces.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedString $name The name of the fee should describe for the subscriber in few words for what the fee is for.
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\PersistableCurrencyAmount[]
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PersistableCurrencyAmount[] $on_downgrade_credited_amount When the subscription is changed and the change is considered as a downgrade the amount defined by this property will be credited to the subscriber.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PersistableCurrencyAmount[] $on_upgrade_credited_amount When the subscription is changed and the change is considered as a upgrade the amount defined by this property will be credited to the subscriber.
     *
     * @return $this
     */
     ...
     * Sets setup_fee
     *
     * @param \WeArePlanet\Sdk\Model\PersistableCurrencyAmount[] $setup_fee The setup fee is charged when the subscriber subscribes to this component. The setup fee is debited with the first charge for the subscriptions.
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \WeArePlanet\Sdk\Model\ProductFeeType
     */
     ...
     * Sets type
     *
     * @param \WeArePlanet\Sdk\Model\ProductFeeType $type 
     *
     * @return $this
     */
