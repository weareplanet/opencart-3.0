...
class AbstractSubscriptionProductActive implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'sort_order' => 'int',
        'state' => '\WeArePlanet\Sdk\Model\SubscriptionProductState'
    ];
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\SubscriptionProductState
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\SubscriptionProductState $state 
     *
     * @return $this
     */
