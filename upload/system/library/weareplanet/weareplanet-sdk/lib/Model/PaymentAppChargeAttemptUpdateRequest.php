...
class PaymentAppChargeAttemptUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'reference' => 'string',
        'target_state' => '\WeArePlanet\Sdk\Model\PaymentAppChargeAttemptTargetState'
    ];
     ...
     * Gets target_state
     *
     * @return \WeArePlanet\Sdk\Model\PaymentAppChargeAttemptTargetState
     */
     ...
     * Sets target_state
     *
     * @param \WeArePlanet\Sdk\Model\PaymentAppChargeAttemptTargetState $target_state The target state defines the state into which the charge attempt should be switched into. Once the charge attempt changed the state it will not be possible to change it again.
     *
     * @return $this
     */
