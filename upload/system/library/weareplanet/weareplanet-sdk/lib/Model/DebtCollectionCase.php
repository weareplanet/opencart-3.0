...
class DebtCollectionCase implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'closed_on' => '\DateTime',
        'collector_configuration' => '\WeArePlanet\Sdk\Model\DebtCollectorConfiguration',
        'contract_date' => '\DateTime',
        'created_on' => '\DateTime',
        'creator' => 'int',
        'currency' => 'string',
        'due_date' => '\DateTime',
        'environment' => '\WeArePlanet\Sdk\Model\DebtCollectionEnvironment',
        'external_id' => 'string',
        'failed_on' => '\DateTime',
        ...
        'reviewer' => 'int',
        'source' => '\WeArePlanet\Sdk\Model\DebtCollectionCaseSource',
        'source_entity_id' => 'int',
        'space_view_id' => 'int',
        'state' => '\WeArePlanet\Sdk\Model\DebtCollectionCaseState',
        'version' => 'int'
    ];
     ...
     *
     * @param \WeArePlanet\Sdk\Model\Address $billing_address The billing address of the case identifies the debtor.
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\DebtCollectorConfiguration
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\DebtCollectorConfiguration $collector_configuration The collector configuration determines how the debt collection case is processed.
     *
     * @return $this
     */
     ...
     * Gets environment
     *
     * @return \WeArePlanet\Sdk\Model\DebtCollectionEnvironment
     */
     ...
     * Sets environment
     *
     * @param \WeArePlanet\Sdk\Model\DebtCollectionEnvironment $environment The environment in which this case will be processed. There must be a debt collector configuration present which supports the chosen environment.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $line_items The line items of the debt collection case will be shown on documents sent to the debtor and the total of them makes up total amount to collect.
     *
     * @return $this
     */
     ...
     * Gets source
     *
     * @return \WeArePlanet\Sdk\Model\DebtCollectionCaseSource
     */
     ...
     * Sets source
     *
     * @param \WeArePlanet\Sdk\Model\DebtCollectionCaseSource $source The source of the debt collection case indicates the origin of the amount receivable.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\DebtCollectionCaseState
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\DebtCollectionCaseState $state 
     *
     * @return $this
     */
