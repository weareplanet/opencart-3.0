...
class ProductPeriodFee implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'int',
        'ledger_entry_title' => '\WeArePlanet\Sdk\Model\DatabaseTranslatedString',
        'linked_space_id' => 'int',
        'name' => '\WeArePlanet\Sdk\Model\DatabaseTranslatedString',
        'number_of_free_trial_periods' => 'int',
        'period_fee' => '\WeArePlanet\Sdk\Model\PersistableCurrencyAmount[]',
     ...
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedString $ledger_entry_title The ledger entry title will be used for the title in the ledger entry and in the invoice.
     *
     * @return $this
     */
     ...
     * Sets period_fee
     *
     * @param \WeArePlanet\Sdk\Model\PersistableCurrencyAmount[] $period_fee The period fee is charged for every period of the subscription except for those periods which are trial periods.
     *
     * @return $this
     */
