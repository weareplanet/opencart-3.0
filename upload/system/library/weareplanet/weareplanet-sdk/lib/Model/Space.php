...
class Space implements ModelInterface, ArrayAccess
{
     ...
     * Sets account
     *
     * @param \WeArePlanet\Sdk\Model\Account $account The account to which the space belongs to.
     *
     * @return $this
     */
     ...
     * Sets database
     *
     * @param \WeArePlanet\Sdk\Model\TenantDatabase $database The database in which the space's data are stored in.
     *
     * @return $this
     */
     ...
     * Sets postal_address
     *
     * @param \WeArePlanet\Sdk\Model\SpaceAddress $postal_address The address to use in communication with clients for example in email, documents etc.
     *
     * @return $this
     */
