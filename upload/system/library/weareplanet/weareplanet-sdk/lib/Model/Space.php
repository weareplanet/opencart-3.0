...
class Space implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'created_by' => 'int',
        'created_on' => '\DateTime',
        'database' => '\WeArePlanet\Sdk\Model\TenantDatabase',
        'deleted_by' => 'int',
        'deleted_on' => '\DateTime',
        'id' => 'int',
        ...
        'postal_address' => '\WeArePlanet\Sdk\Model\SpaceAddress',
     ...
     * Sets account
     *
     * @param \WeArePlanet\Sdk\Model\Account $account The account that the space belongs to.
     *
     * @return $this
     */
     ...
     * Gets database
     *
     * @return \WeArePlanet\Sdk\Model\TenantDatabase
     */
     ...
     * Sets database
     *
     * @param \WeArePlanet\Sdk\Model\TenantDatabase $database The database the space is connected to and that holds the space's data.
     *
     * @return $this
     */
     ...
     * Gets postal_address
     *
     * @return \WeArePlanet\Sdk\Model\SpaceAddress
     */
     ...
     * Sets postal_address
     *
     * @param \WeArePlanet\Sdk\Model\SpaceAddress $postal_address The address that is used in communication with clients for example in emails, documents, etc.
     *
     * @return $this
     */
