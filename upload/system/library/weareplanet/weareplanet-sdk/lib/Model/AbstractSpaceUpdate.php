...
class AbstractSpaceUpdate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'postal_address' => '\WeArePlanet\Sdk\Model\SpaceAddressCreate',
     ...
     * Gets postal_address
     *
     * @return \WeArePlanet\Sdk\Model\SpaceAddressCreate
     */
     ...
     * Sets postal_address
     *
     * @param \WeArePlanet\Sdk\Model\SpaceAddressCreate $postal_address The address that is used in communication with clients for example in emails, documents, etc.
     *
     * @return $this
     */
