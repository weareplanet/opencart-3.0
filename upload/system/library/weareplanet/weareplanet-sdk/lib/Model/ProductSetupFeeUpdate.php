...
class ProductSetupFeeUpdate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'version' => 'int',
        'component' => 'int',
        'description' => '\WeArePlanet\Sdk\Model\DatabaseTranslatedStringCreate',
        'name' => '\WeArePlanet\Sdk\Model\DatabaseTranslatedStringCreate',
        'on_downgrade_credited_amount' => '\WeArePlanet\Sdk\Model\PersistableCurrencyAmountUpdate[]',
        'on_upgrade_credited_amount' => '\WeArePlanet\Sdk\Model\PersistableCurrencyAmountUpdate[]',
        'setup_fee' => '\WeArePlanet\Sdk\Model\PersistableCurrencyAmountUpdate[]'
    ];
     ...
     * Gets description
     *
     * @return \WeArePlanet\Sdk\Model\DatabaseTranslatedStringCreate
     */
     ...
     * Sets description
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedStringCreate $description The description of a component fee describes the fee to the subscriber. The description may be shown in documents or on certain user interfaces.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedStringCreate $name The name of the fee should describe for the subscriber in few words for what the fee is for.
     *
     * @return $this
     */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\PersistableCurrencyAmountUpdate[]
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PersistableCurrencyAmountUpdate[] $on_downgrade_credited_amount When the subscription is changed and the change is considered as a downgrade the amount defined by this property will be credited to the subscriber.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PersistableCurrencyAmountUpdate[] $on_upgrade_credited_amount When the subscription is changed and the change is considered as a upgrade the amount defined by this property will be credited to the subscriber.
     *
     * @return $this
     */
     ...
     * Sets setup_fee
     *
     * @param \WeArePlanet\Sdk\Model\PersistableCurrencyAmountUpdate[] $setup_fee The setup fee is charged when the subscriber subscribes to this component. The setup fee is debited with the first charge for the subscriptions.
     *
     * @return $this
     */
