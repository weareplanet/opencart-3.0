...
class DocumentTemplateTypeService {
	 ...
	 * @return \WeArePlanet\Sdk\Model\DocumentTemplateType[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\WeArePlanet\Sdk\Model\DocumentTemplateType[]',
				'/document-template-type/all'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\WeArePlanet\Sdk\Model\DocumentTemplateType[]', $response->getHeaders()));
