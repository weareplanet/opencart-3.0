...
class DebtCollectorService {
	 ...
	 * @return \WeArePlanet\Sdk\Model\DebtCollector[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\WeArePlanet\Sdk\Model\DebtCollector[]',
				'/debt-collector/all'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\WeArePlanet\Sdk\Model\DebtCollector[]', $response->getHeaders()));
