...
class InstallmentPlanCalculationService {
	 ...
	 * @return \WeArePlanet\Sdk\Model\InstallmentCalculatedPlan[]
	 */
	...
	public function calculatePlansWithHttpInfo($space_id, $transaction_id) {
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\WeArePlanet\Sdk\Model\InstallmentCalculatedPlan[]',
				'/installment-plan-calculation/calculatePlans'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\WeArePlanet\Sdk\Model\InstallmentCalculatedPlan[]', $response->getHeaders()));
