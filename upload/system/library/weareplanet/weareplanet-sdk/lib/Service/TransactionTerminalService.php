...
class TransactionTerminalService {
	 ...
	 * @return \WeArePlanet\Sdk\Model\RenderedTerminalReceipt
	 */
	...
	public function receiptWithHttpInfo($space_id, $transaction_id, $type_id, $width) {
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\WeArePlanet\Sdk\Model\RenderedTerminalReceipt',
				'/transaction-terminal/receipt'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\WeArePlanet\Sdk\Model\RenderedTerminalReceipt', $response->getHeaders()));
