...
class StaticValueService {
	 ...
	 * @return \WeArePlanet\Sdk\Model\StaticValue[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\WeArePlanet\Sdk\Model\StaticValue[]',
				'/static-value-service/all'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\WeArePlanet\Sdk\Model\StaticValue[]', $response->getHeaders()));
