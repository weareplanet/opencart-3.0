...
class MerticUsageService {
	 ...
	 * @return \WeArePlanet\Sdk\Model\MetricUsage[]
	 */
	...
	public function calculateWithHttpInfo($space_id, $start, $end) {
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\WeArePlanet\Sdk\Model\MetricUsage[]',
				'/mertic-usage/calculate'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\WeArePlanet\Sdk\Model\MetricUsage[]', $response->getHeaders()));
