...
class CardProcessingService {
	 ...
	 * @param \WeArePlanet\Sdk\Model\UnencryptedCardDataCreate $card_data The card details as JSON in plain which should be used to authorize the payment. (required)
